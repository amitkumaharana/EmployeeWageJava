public class employeewage{
	public static void main(String[] args){
		...
		int daily_employee_wage = 0, wage_per_hour = 20, full_day_hour = 8, part_time_hour = 8, monthly_wage = 0;
		int i;
		for(i=1;i<=20;i++){
				...
				case 0:
					...
					switch ((int)part_time){
						case 0:
							...
							break;
						case 1:
							daily_employee_wage = wage_per_hour * full_day_hour;						System.out.println("Worked Full Time");
